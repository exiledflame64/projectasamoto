...
const TArray<FBlueprintDef>& GetBlueprintCatalog()
{
	static const TArray<FBlueprintDef> Catalog = {
		...
		{ EBlueprintKind::Farm,       EBuildingType::Farm,
			...
			true },
		{ EBlueprintKind::Temple,     EBuildingType::Temple,
			NSLOCTEXT("Realm", "BP_Temple",     "Temple"),
			NSLOCTEXT("Realm", "TT_Temple",
				"A place of worship. Lets houses promote Peasants to Monks.\nWorkers: Monk, Warrior Monk."),
			true },
		{ EBlueprintKind::Dojo,       EBuildingType::Dojo,
			NSLOCTEXT("Realm", "BP_Dojo",       "Dojo"),
			NSLOCTEXT("Realm", "TT_Dojo",
				"A training hall. Lets houses promote Artisans to Samurai.\nWorkers: Samurai."),
			true },
